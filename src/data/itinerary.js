...
export const habsburgIntro =
  '此區為歷史背景補充：這趟行程實際經過的地點中，哪些跟哈布斯堡王朝（Habsburg）有過統治或血緣關係，哪些完全無關。'

export const habsburgSections = [
  {
    q: '米蘭（8/6-8/7）：唯一被哈布斯堡直接統治過的地方',
    a: '米蘭在歷史上分兩段被哈布斯堡統治：<b>西班牙哈布斯堡（1535-1707年）</b>與<b>奧地利哈布斯堡（1707-1796年、1815-1859年）</b>，中間有拿破崙時期的中斷。1815年維也納會議後，米蘭併入「倫巴第-威尼西亞王國」，由奧地利皇帝兼任國王，直到1859年第二次義大利獨立戰爭後割讓給薩丁尼亞王國。<br><br>大教堂周邊留下不少哈布斯堡時代建築：<b>史卡拉歌劇院</b>（1776-1778年瑪麗亞·特蕾莎女皇統治下建成）、<b>王宮 Palazzo Reale</b>（曾為奧地利總督官邸）、<b>蒙特拿破崙大街</b>（奧地利統治時期開發的精品街區）。大教堂本身建造年代跨越哈布斯堡統治期，但非哈布斯堡委託建造。',
  },
  {
    q: '瑞士各站（庫爾／聖莫里茲／達沃斯／策馬特／薩斯菲／伯恩／格林德瓦／盧森／蘇黎世）：發源地，卻是「脫離」的歷史',
    a: '哈布斯堡家族名稱本身來自<b>哈布斯堡城堡（Habsburg Castle，約1020年建於瑞士阿爾高州Aargau）</b>，是家族真正的發源地——但這座城堡不在本次行程路線上。<br><br>有意思的是，你們實際走過的瑞士城市，歷史上幾乎都是<b>對抗、脫離哈布斯堡統治</b>的一方：',
    list: [
      '瑞士邦聯獨立關鍵戰役：莫爾加滕戰役（1315年）、森帕赫戰役（1386年）',
      '庫爾／聖莫里茲／達沃斯：屬格里松地區聯盟（Grisons leagues），歷史上抵抗哈布斯堡',
      '策馬特／薩斯菲：屬瓦萊州，實際受錢主教（Bishop of Sion）管轄，與哈布斯堡無直接關係',
      '蘇黎世：1351年加入瑞士邦聯，附近有基堡城堡（Kyburg Castle）',
      '伯恩：1339年勞芬戰役（Battle of Laupen）中對抗哈布斯堡軍隊的一方；熊公園的熊傳統來自伯恩建城傳說，跟哈布斯堡完全無關',
      '盧森：卡貝爾橋建於1333年，是盧森脫離哈布斯堡統治（1332年）之後才建的；獅子紀念碑紀念1792年法國大革命期間陣亡的瑞士衛隊，也跟哈布斯堡無關',
      '格林德瓦：屬伯恩管轄範圍',
    ],
  },
  {
    q: '菲森／慕尼黑：從未是哈布斯堡領土，僅有聯姻關係',
    a: '巴伐利亞由<b>維特爾斯巴赫家族（Wittelsbach，1180-1918年）</b>統治，跟哈布斯堡是不同家族，從未被哈布斯堡直接統治。新天鵜堡（Neuschwanstein）是維特爾斯巴赫的路德維希二世建造的，跟哈布斯堡無關。<br><br>兩個家族最著名的連結是聯姻：<b>茜茜公主（Sisi）本是維特爾斯巴赫家族公主，嫁給哈布斯堡的法蘭茲·約瑟夫一世皇帝</b>，成為奧匈帝國皇后。菲森靠近奧地利邊境，隔壁的提洛爾地區自1363年起由哈布斯堡統治。',
  },
]

export const habsburgSummary =
  '<b>總結：</b>這趟行程唯一真正被哈布斯堡統治過的地方是<b>米蘭</b>；瑞士是哈布斯堡家族的發源地，但實際走過的瑞士城市大多是脫離/對抗哈布斯堡獨立出來的歷史現場；巴伐利亞（菲森／慕尼黑）從未屬於哈布斯堡領土，僅透過茜茜公主聯姻與哈布斯堡產生血緣關係。'
